...
urlpatterns = [
    path('faq/', support_views.QuestionListView.as_view(), name='question_list'),
    path('faq/<slug:slug>/', support_views.QuestionDetailView.as_view(), name='question_detail'),
    path('faq/topics/<slug:slug>', support_views.TopicDetailView.as_view(), name='topic_detail'),
